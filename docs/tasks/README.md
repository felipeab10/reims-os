...
- [-] [T008 — Diferenciar shutdown/reboot normal de crash/kernel panic](T008-lifecycle-classification.md) — corrective validation: QMP ShutdownCause reason-aware classification
